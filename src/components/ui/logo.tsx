  ...
  return (
    <div className={cn("inline-flex items-center gap-1.5", className)}>
      ...
      >
        ...
        <span className="absolute -top-1 -right-1 w-3 h-3 text-white/80">
          🦋
        </span>
        <Sparkle
          className="absolute -top-2 right-0.5 w-2 h-2 text-devine-gold"
          strokeWidth={2}
        />
      </div>
      <span
        className={cn(
          textSizes[size],
          "font-display font-semibold tracking-normal leading-none text-white",
        )}
      >
        Devine
      </span>
