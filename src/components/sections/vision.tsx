        ...
        <div className="space-y-12">
          <ScrollReveal delay={0.2}>
            <div className="relative">
              {/* Floating emoji */}
              <motion.span
                className="absolute -left-8 top-0 text-3xl hidden lg:block"
          ...
          <ScrollReveal delay={0.3}>
            <div className="relative bg-white/[0.03] backdrop-blur-sm rounded-2xl border border-white/[0.06] p-8 sm:p-10">
              ...
              <p className="text-lg sm:text-xl text-white/70 leading-relaxed">
                ...
                чтобы дарить тебе моменты, которые запоминаются навсегда.
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.4}>
            <div className="relative bg-white/[0.03] backdrop-blur-sm rounded-2xl border border-white/[0.06] p-8 sm:p-10">
              ...
              <p className="text-lg sm:text-xl text-white/70 leading-relaxed">
                🐾 Мы сочетаем академическую поддержку, социальные события и направление
