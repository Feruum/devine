  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 text-center">
        {/* Floating emojis */}
        <motion.span
          className="absolute top-16 left-[10%] text-3xl hidden sm:block"
        ...
        <motion.span
          className="absolute bottom-16 right-[10%] text-2xl hidden sm:block"
          animate={{ y: [8, -12, 8] }}
        ...
        <ScrollReveal delay={0.15}>
          <p className="text-lg sm:text-xl text-devine-navy/60 mb-10 leading-relaxed">
            Присоединяйся к Devine — пространству, где ты можешь быть собой, расти и вдохновлять других 🤍
          </p>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.3}>
          ...
          >
            ...
            >
              Присоединяйся к Devine прямо сейчас 🐾
            </motion.button>
          </a>
        </ScrollReveal>
      </div>
